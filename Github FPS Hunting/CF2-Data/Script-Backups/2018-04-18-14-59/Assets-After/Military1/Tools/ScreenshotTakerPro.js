function Update() {
	if (ControlFreak2.CF2Input.GetKeyDown (KeyCode.P) || ControlFreak2.CF2Input.GetKeyDown (KeyCode.O)) {
		var oversizedScreenshot : boolean = ControlFreak2.CF2Input.GetKeyDown (KeyCode.O);
		
		var resWidth : int = 4444;
		var resHeight : int = 2500;
