...
public class PlayerWeapon : MonoBehaviour {
	...
	void FixedUpdate () 
	{
		if(ControlFreak2.CF2Input.GetMouseButton(0) && attackTimer >= attackTime && !calculatedHit)
		{
		...
		if(ControlFreak2.CF2Input.GetMouseButton(0) && attackSoundTimer >= attackTime + attackDelay)
		{
			if (useAttackSound)
			{
